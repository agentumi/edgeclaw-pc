...
impl TemplateRegistry {
    ...
    pub fn default_library() -> Self {
        ...
        registry
            .templates
            .extend(crate::workflows::investment::get_templates());
        registry
            .templates
            .extend(crate::workflows::business::get_templates());
        registry
    }
...
fn marketing_templates() -> Vec<TaskTemplate> {
    vec![
        ...
        // ─── P2-02: Market Analysis Template ────────────────────
        TaskTemplate {
            id: "biz.market_analysis".into(),
            name: "시장 분석 보고서".into(),
            description: "경쟁사 분석, 시장 동향, SWOT 분석이 포함된 종합 시장 분석 보고서 생성".into(),
            category: TemplateCategory::Marketing,
            required_role: RequiredRole::Viewer,
            capability: "status_query".into(),
            tags: vec!["market".into(), "analysis".into(), "swot".into(), "competitor".into(), "business".into()],
            steps: vec![
                TemplateStep {
                    order: 1,
                    description: "Collect market data".into(),
                    command: "echo".into(),
                    args: vec!["[MarketAnalysis] Collecting market data for {{industry}} sector in {{region}}...".into()],
                    working_dir: None,
                    timeout_secs: 30,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 2,
                    description: "Analyze competitors".into(),
                    command: "echo".into(),
                    args: vec!["[MarketAnalysis] Analyzing top {{competitor_count}} competitors...".into()],
                    working_dir: None,
                    timeout_secs: 30,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 3,
                    description: "Generate SWOT matrix".into(),
                    command: "echo".into(),
                    args: vec!["[MarketAnalysis] Generating SWOT analysis for {{company_name}}...".into()],
                    working_dir: None,
                    timeout_secs: 15,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 4,
                    description: "Compile market report".into(),
                    command: "echo".into(),
                    args: vec!["[MarketAnalysis] Report complete — {{industry}} | {{region}} | {{competitor_count}} competitors analyzed".into()],
                    working_dir: None,
                    timeout_secs: 10,
                    abort_on_failure: false,
                    optional: false,
            ...
            params: vec![
                TemplateParam {
                    name: "industry".into(),
                    description: "Target industry sector".into(),
                    default: Some("SaaS".into()),
                    required: false,
                    examples: vec!["SaaS".into(), "FinTech".into(), "AI/ML".into(), "E-commerce".into()],
                },
                TemplateParam {
                    name: "region".into(),
                    description: "Geographic region".into(),
                    default: Some("global".into()),
                    required: false,
                    examples: vec!["global".into(), "APAC".into(), "NA".into(), "EU".into()],
                },
                TemplateParam {
                    name: "competitor_count".into(),
                    description: "Number of competitors to analyze".into(),
                    default: Some("5".into()),
                    required: false,
                    examples: vec!["3".into(), "5".into(), "10".into()],
                },
                TemplateParam {
                    name: "company_name".into(),
                    description: "Your company name for SWOT".into(),
                    default: Some("EdgeClaw".into()),
                    required: false,
                    examples: vec!["EdgeClaw".into(), "My Company".into()],
                },
            ],
            platforms: vec![],
            estimated_secs: 85,
        ...
        // ─── P2-03: Customer Churn Analysis Template ────────────
        TaskTemplate {
            id: "biz.customer_churn".into(),
            name: "고객 이탈 분석".into(),
            description: "고객 이탈률 추적, 이탈 위험 고객 식별, 유지 전략 제안을 포함한 이탈 분석 자동화".into(),
            category: TemplateCategory::Marketing,
            required_role: RequiredRole::Viewer,
            capability: "status_query".into(),
            tags: vec!["churn".into(), "customer".into(), "retention".into(), "analysis".into(), "business".into()],
            steps: vec![
                TemplateStep {
                    order: 1,
                    description: "Collect customer activity data".into(),
                    command: "echo".into(),
                    args: vec!["[ChurnAnalysis] Collecting {{period}} customer activity for segment: {{segment}}...".into()],
                    working_dir: None,
                    timeout_secs: 20,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 2,
                    description: "Calculate churn metrics".into(),
                    command: "echo".into(),
                    args: vec!["[ChurnAnalysis] Computing MRR churn, logo churn, and cohort retention...".into()],
                    working_dir: None,
                    timeout_secs: 15,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 3,
                    description: "Identify at-risk customers".into(),
                    command: "echo".into(),
                    args: vec!["[ChurnAnalysis] Scoring customers by churn risk (threshold: {{risk_threshold}})...".into()],
                    working_dir: None,
                    timeout_secs: 15,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 4,
                    description: "Generate retention recommendations".into(),
                    command: "echo".into(),
                    args: vec!["[ChurnAnalysis] Generating retention playbook with top-3 interventions...".into()],
                    working_dir: None,
                    timeout_secs: 10,
                    abort_on_failure: false,
                    optional: false,
            ...
            params: vec![
                TemplateParam {
                    name: "period".into(),
                    description: "Analysis period".into(),
                    default: Some("90d".into()),
                    required: false,
                    examples: vec!["30d".into(), "90d".into(), "1y".into()],
                },
                TemplateParam {
                    name: "segment".into(),
                    description: "Customer segment to analyze".into(),
                    default: Some("all".into()),
                    required: false,
                    examples: vec!["enterprise".into(), "smb".into(), "all".into()],
                },
                TemplateParam {
                    name: "risk_threshold".into(),
                    description: "Churn risk score threshold (0-1)".into(),
                    default: Some("0.7".into()),
                    required: false,
                    examples: vec!["0.5".into(), "0.7".into(), "0.9".into()],
                },
            ],
            platforms: vec![],
            estimated_secs: 60,
        ...
        // ─── P2-04: KPI Dashboard Report Template ───────────────
        TaskTemplate {
            id: "biz.kpi_dashboard".into(),
            name: "KPI 대시보드 보고서".into(),
            description: "핵심 성과 지표(KPI) 수집, 목표 달성률 계산, 경영진 대시보드 보고서 자동 생성".into(),
            category: TemplateCategory::Marketing,
            required_role: RequiredRole::Viewer,
            capability: "status_query".into(),
            tags: vec!["kpi".into(), "dashboard".into(), "metrics".into(), "report".into(), "business".into()],
            steps: vec![
                TemplateStep {
                    order: 1,
                    description: "Collect KPI data sources".into(),
                    command: "echo".into(),
                    args: vec!["[KPI] Aggregating {{kpi_category}} KPIs for {{period}}...".into()],
                    working_dir: None,
                    timeout_secs: 20,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 2,
                    description: "Calculate target achievement".into(),
                    command: "echo".into(),
                    args: vec!["[KPI] Computing target vs actual for {{kpi_count}} metrics...".into()],
                    working_dir: None,
                    timeout_secs: 15,
                    abort_on_failure: false,
                    optional: false,
                ...
                TemplateStep {
                    order: 3,
                    description: "Detect trend anomalies".into(),
                    command: "echo".into(),
                    args: vec!["[KPI] Running anomaly detection (σ threshold: {{sigma}})...".into()],
                    working_dir: None,
                    timeout_secs: 15,
                    abort_on_failure: false,
                    optional: true,
                ...
                TemplateStep {
                    order: 4,
                    description: "Generate executive summary".into(),
                    command: "echo".into(),
                    args: vec!["[KPI] Rendering executive dashboard for {{department}}...".into()],
                    working_dir: None,
                    timeout_secs: 10,
                    abort_on_failure: false,
                    optional: false,
            ...
            params: vec![
                TemplateParam {
                    name: "period".into(),
                    description: "Report period".into(),
                    default: Some("weekly".into()),
                    required: false,
                    examples: vec!["daily".into(), "weekly".into(), "monthly".into(), "quarterly".into()],
                },
                TemplateParam {
                    name: "department".into(),
                    description: "Department for KPI rollup".into(),
                    default: Some("all".into()),
                    required: false,
                    examples: vec!["engineering".into(), "sales".into(), "marketing".into(), "all".into()],
                },
                TemplateParam {
                    name: "kpi_category".into(),
                    description: "KPI category filter".into(),
                    default: Some("revenue".into()),
                    required: false,
                    examples: vec!["revenue".into(), "growth".into(), "operational".into(), "customer".into()],
                },
                TemplateParam {
                    name: "kpi_count".into(),
                    description: "Number of KPIs to track".into(),
                ...
                TemplateParam {
                    name: "sigma".into(),
                    description: "Standard deviation threshold for anomaly detection".into(),
                    default: Some("2.0".into()),
                    required: false,
                    examples: vec!["1.5".into(), "2.0".into(), "3.0".into()],
                },
            ],
            platforms: vec![],
            estimated_secs: 60,
